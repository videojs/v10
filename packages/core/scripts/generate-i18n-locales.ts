...
import { BUILT_IN_LOCALES, LOCALE_ALIAS_TAGS, SHIPPED_LOCALE_TAGS } from '../src/core/i18n/locales.ts';
...
function generateCoreAllTs(): string {
  const importTags = ['en', ...BUILT_IN_LOCALES, ...LOCALE_ALIAS_TAGS].sort();
