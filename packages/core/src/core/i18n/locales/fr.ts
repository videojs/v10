...
export default {
  ...
  timeToggleElapsed: '{duration}. Afficher le temps écoulé.',
  timeToggleDuration: '{duration}. Afficher la durée.',
  timeToggleRemaining: '{duration}. Afficher le temps restant.',
