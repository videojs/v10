...
export default {
  ...
  'You stopped media playback before it finished.': 'Vous avez interrompu la lecture de la vidéo.',
  ...
  OK: 'Fermer',
  'An unexpected error occurred.': 'Une erreur s’est produite. Veuillez réessayer.',
  Settings: 'Paramètres',
  Quality: 'Qualité',
  Audio: 'Audio',
  Default: 'Par défaut',
