...
export default {
  ...
  time: {
    ...
    elapsedSuffix: '{duration} অতিবাহিত সময়',
    durationSuffix: '{duration} সময়কাল',
    remainingSuffix: 'বাকি {duration}',
    showElapsed: 'অতিবাহিত সময় দেখান, {duration}.',
    showDuration: 'সময়কাল দেখান, {duration}.',
    showRemaining: 'বাকি সময় দেখান, {duration}.',
    toggleElapsed: 'অতিবাহিত সময় ও বাকি সময়ের মধ্যে টগল করুন।',
    toggleDuration: 'সময়কাল ও বাকি সময়ের মধ্যে টগল করুন।',
  ...
  errors: {
    ...
    unplayable: 'এই মিডিয়া প্লেয়ার দ্বারা সমর্থিত নয়।',
