/**
 * SimpleAudioOnlyHlsMediaElement adapter tests.
 *
...
import { SimpleAudioOnlyHlsMediaElement } from '../adapter-audio-only';

describe('SimpleAudioOnlyHlsMediaElement', () => {
  beforeEach(() => {
    vi.stubGlobal(
      'fetch',
  ...
  describe('src', () => {
    it('returns empty string before any src is set', () => {
      const media = new SimpleAudioOnlyHlsMediaElement();
