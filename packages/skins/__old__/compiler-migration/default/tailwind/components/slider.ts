...
export const slider = {
  ...
  thumb: {
    base: cn(
      ...
      // Focus ring via ::after pseudo (white border ring; matches vanilla `slider.css:83-92,94-97`)
      "after:content-[''] after:absolute after:-inset-1 after:rounded-[inherit]",
      'after:shadow-[0_0_0_2px_oklch(1_0_0)]',
      'after:transition-[opacity,scale] after:duration-150 after:ease-out',
      'not-focus-visible:after:scale-50 not-focus-visible:after:opacity-0'
    ),
    persistent: 'size-3',
    interactive: cn(
      'size-2.5',
