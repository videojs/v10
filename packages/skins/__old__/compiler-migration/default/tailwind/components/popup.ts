...
export const popup = {
  ...
  volume: cn(
    'py-3 px-0 rounded-full',
    // Hide entirely when the volume slider reports unsupported availability
    // (matches vanilla `popup.css:81-88`).
    'has-[media-volume-slider[data-availability=unsupported]]:hidden'
  ),
};
