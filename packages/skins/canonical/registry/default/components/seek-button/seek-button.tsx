    ...
    <ButtonTooltip side="top">
      ...
      >
        <SeekIcon
          className={
            seconds < 0
              ? 'size-media-icon drop-shadow-media-icon -scale-x-100'
