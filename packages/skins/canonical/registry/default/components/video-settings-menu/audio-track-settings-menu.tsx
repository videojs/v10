import { AudioTrackRadioGroup, Menu, useTranslator, useAudioTrackOptions } from '@videojs/react';
import { audioText } from '@videojs/core/i18n/text/menu';
import { CheckIcon, SpeechIcon } from '@videojs/react/icons';
import { MenuChevron } from './menu-chevron';
import { cn } from '@/components/videojs/utils';

export interface AudioTrackSettingsMenuProps extends Menu.RootProps {}

export function AudioTrackSettingsMenu({ ...props }: AudioTrackSettingsMenuProps = {}) {
