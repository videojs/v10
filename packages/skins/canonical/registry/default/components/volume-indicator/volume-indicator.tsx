...
export function VolumeIndicator() {
  return (
    <VolumeIndicatorPrimitive.Root className="group/volume-status pointer-events-none absolute top-3 w-[min(80%,12rem)] rounded-media-pill bg-black/25 font-medium transition-[opacity,scale,translate] duration-100 ease-out data-starting-style:scale-90 data-starting-style:opacity-0 data-ending-style:-translate-y-1/4 data-ending-style:scale-90 data-ending-style:opacity-0">
