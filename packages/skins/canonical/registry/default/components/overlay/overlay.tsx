...
export interface OverlayProps extends Omit<ComponentProps<'div'>, 'children'> {}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        '[transition-property:opacity,backdrop-filter] [transition-duration:var(--media-controls-transition-duration)] [transition-timing-function:ease-out]',
