...
export function BufferingIndicator() {
  return (
    <BufferingIndicatorPrimitive className="peer/buffering pointer-events-none absolute inset-0 z-10 hidden place-content-center text-white not-data-visible:[--media-spinner-animation:none] data-visible:grid">
