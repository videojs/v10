...
export default defineStyles({
  ...
  styles: {
    container: [
      ...
      'outline-2 -outline-offset-4 outline-transparent transition-[outline-offset,outline-color] duration-(--media-duration-fast) ease-media-out',
      ...
      'before:transition-opacity before:duration-250 before:ease-media-in-out',
