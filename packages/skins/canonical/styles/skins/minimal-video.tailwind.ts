  ...
  styles: {
    controls: {
      root: [
        ...
        'p-media-controls-padding transition-[filter,opacity,translate]',
        'duration-[calc(var(--media-controls-transition-duration)/2)] ease-media-out',
    ...
    timeControls: [
      ...
      '@2xl/media-root:[transition:mask-position_50ms_var(--media-ease-out)]',
