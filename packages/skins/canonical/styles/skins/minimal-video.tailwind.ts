...
export default defineStyles({
  ...
  styles: {
    controls: {
      root: [
        'peer/controls group/controls absolute inset-x-1 bottom-1 z-20 flex flex-wrap items-center gap-x-2 rounded-xl text-white',
        ...
        '[transition-duration:calc(var(--controls-transition-duration)/2)] [transition-timing-function:ease-out]',
        'not-data-visible:pointer-events-none not-data-visible:opacity-0',
        'not-data-visible:[transition-duration:var(--controls-transition-duration)]',
