  ...
  styles: {
    controls: {
      root: [
        ...
        '@lg/media-root:bg-media-surface @lg/media-root:shadow-media-surface @lg/media-root:backdrop-blur-media-surface',
        ...
        '[transition-property:filter,opacity,scale,translate] [transition-duration:var(--controls-transition-duration)] [transition-timing-function:ease-out]',
        'peer-data-open/error:hidden!',
      ],
      primary: [
        'absolute inset-x-2 bottom-2 z-10 flex origin-bottom items-center rounded-media-pill',
        'bg-media-surface p-media-controls-padding shadow-media-surface backdrop-blur-media-surface',
