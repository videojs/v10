...
export const fillBase = 'absolute rounded-[inherit] pointer-events-none';

export const fill = cn(
  'bg-current',
  // Horizontal
...
/** Compatibility namespace for the existing aggregate token imports. */
export const slider = {
  root,
  track,
  fillBase,
