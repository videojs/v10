...
export default styles({
  ...
  rules: {
    ...
    separator: {
      utilities: 'hidden media-2xl:inline media-2xl:media-current-mix:text-current/60',
    },
    durationValue: {
      utilities:
        'tabular-nums transition-opacity duration-media-slow ease-out data-unavailable:opacity-50 media-2xl:media-current-mix:text-current/60',
    },
  },
});
