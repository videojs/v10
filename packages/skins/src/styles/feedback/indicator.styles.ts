    ...
    root: {
      ...
      variants: {
        default: [
          ...
          'pointer-fine:data-starting-style:scale-(--media-indicator-hidden-scale) pointer-fine:data-starting-style:blur-(--media-hidden-blur)',
          'pointer-fine:data-ending-style:scale-(--media-indicator-hidden-scale) pointer-fine:data-ending-style:blur-(--media-hidden-blur)',
          'data-ending-style:translate-y-(--media-indicator-hidden-offset)',
        ],
        minimal: [
          ...
          'pointer-fine:data-starting-style:blur-(--media-hidden-blur) pointer-fine:data-ending-style:blur-(--media-hidden-blur)',
          'data-ending-style:translate-y-(--media-indicator-hidden-offset)',
        ],
      },
    },
