...
const themedIcon = themeRecipe(
  'mix-blend-difference',
  'col-start-1 row-start-1 drop-shadow-[0_1px_0_var(--media-shadow-current-color)]'
);
...
export default styles({
  ...
  rules: {
    ...
    fill: {
      ...
      utilities: [
        'items-center justify-between gap-2 rounded-[inherit] px-2.5 py-1',
        ...themeRecipe(
          [
    ...
    value: {
      ...
      utilities: themeRecipe('ml-auto mix-blend-difference', 'col-start-3 row-start-1'),
    },
    highIcon: {
      className: 'media-volume-indicator-high-icon',
      utilities: ['hidden shrink-0 group-data-[level=high]/volume-status:block', ...themedIcon],
    },
    lowIcon: {
      className: 'media-volume-indicator-low-icon',
      utilities: ['hidden shrink-0 group-data-[level=low]/volume-status:block', ...themedIcon],
    },
    offIcon: {
      className: 'media-volume-indicator-off-icon',
      utilities: ['hidden shrink-0 group-data-[level=off]/volume-status:block', ...themedIcon],
    },
  },
});
