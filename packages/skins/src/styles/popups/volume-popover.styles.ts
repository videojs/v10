  ...
  rules: {
    popup: {
      ...
      utilities: [
        ...
        'data-[side=right]:rounded-none data-[side=right]:bg-transparent data-[side=right]:p-0 data-[side=right]:px-3 data-[side=right]:shadow-none! data-[side=right]:backdrop-filter-none data-[side=right]:after:hidden',
      ...
      variants: {
        minimal: [
          ...
          'data-[side=left]:shadow-none! data-[side=left]:backdrop-filter-none data-[side=left]:after:hidden',
