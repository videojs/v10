...
import { createSkinCatalog } from '../canonical/catalog';

export type SkinCatalog = Catalog<ReturnType<typeof createSkinCatalog>>;
...
export function loadSkinCatalog(): Promise<SkinCatalog> {
  return loadCatalog(createSkinCatalog(), { rootDir: canonicalRoot });
}
