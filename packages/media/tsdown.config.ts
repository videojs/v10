...
const createConfig = (mode: PackageBuildMode): UserConfig => ({
  ...
  entry: {
    ...
    predicate: './src/core/predicate.ts',
    error: './src/core/media-error.ts',
    dom: './src/dom/index.ts',
    'dom/audio-host/index': './src/dom/audio-host.ts',
    'dom/media-host/index': './src/dom/media-host.ts',
    'dom/video-host/index': './src/dom/video-host.ts',
