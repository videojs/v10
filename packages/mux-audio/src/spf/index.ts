/**
 * The Mux Media over the SPF audio-only HLS engine. Sibling of `@videojs/mux-video/spf`; see that entry point for the
...
export type { MuxMediaAPI, MuxMediaProps } from '@videojs/mux-video/spf';
export { muxMediaDefaultProps } from '@videojs/mux-video/spf';
