...
# or
pnpm add @videojs/react @videojs/cloudflare-video
```
...
```sh
npx @videojs/cli agents init --framework react --media cloudflare
npx @videojs/cli agents init --framework html --media cloudflare
```
