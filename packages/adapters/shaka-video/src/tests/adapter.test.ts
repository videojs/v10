...
import { KeySystems } from '@videojs/media';

import { shaka, ShakaAdapter, type ShakaSource } from '../index';
...
function setup({ preload = 'auto' as const }: { preload?: ShakaAdapter['preload'] } = {}) {
