...
import { createMuxQuery, MUX_VIDEO_DOMAIN, type MuxJWT, type MuxSourceBase } from '@videojs/mux';
 ...
 *
 * Separate from `./source` because it is the one part of the Mux source an engine that licenses differently has
 * nothing to do with.
 *
 * @internal
 */
