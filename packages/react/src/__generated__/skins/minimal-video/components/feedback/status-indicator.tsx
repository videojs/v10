...
export function StatusIndicator({
  ...
  return (
    <StatusIndicatorPrimitive.Root
      ...
      className={
        variant === 'minimal'
          ? 'media-status-indicator media-status-indicator-minimal'
          : 'media-surface media-status-indicator'
      }
    >
...
export function PlaybackStatusIndicator({
  ...
  return (
    <StatusIndicatorPrimitive.Root
      ...
      className={
        variant === 'minimal'
          ? 'media-playback-status-indicator media-playback-status-indicator-minimal'
