...
- `[audio-only-mode-override]` — audio-only delivery from mixed-manifest sources. Case-2 sibling of [`audio-only-composition`](../features/audio-only-composition.md). *Notion epic #4b.*
