import type { MediaFullEvents } from '@videojs/media';
...
// Default cue points, written as cues onto the metadata `<track>` element and
// readable back off `media.textTracks`.
