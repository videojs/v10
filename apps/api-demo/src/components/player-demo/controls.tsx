...
import type { CuePoint } from './cue-points';
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className={`${PANEL_CLASS} p-6`}>
        <Field label="Cue points">
          <p className="text-xs text-warm-gray dark:text-manila-dark">
            Timed markers with JSON payloads, added as <code className="font-mono">VTTCue</code>s to a{' '}
            <code className="font-mono">&lt;track kind="metadata"&gt;</code> element. Click a row to seek to it.
          </p>
                    ...
                    <td className="px-2 py-1.5 text-right align-middle">
                      <button
                        ...
                        onClick={(event) => {
                          ...
                          log('action', `track.removeCue(cues[${index}]) → ${num(cuePoint.time)}s`);
                        }}
