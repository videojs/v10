 ...
 *
 * `omit` drops an imported file, by resolved absolute path, instead of inlining it. It applies at
 * every depth, so excluding a leaf removes it from every sheet that transitively pulls it in.
 */
