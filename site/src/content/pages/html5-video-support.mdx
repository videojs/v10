...
Video.js ships each of those as a component, so you take the ones you need and keep the rest of the web platform. Read more: <DocsLink slug="concepts/why-videojs">Why Video.js?</DocsLink>
