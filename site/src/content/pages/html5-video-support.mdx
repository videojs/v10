...
Video.js ships each of those as a component, so you take the ones you need and keep the rest of the web platform. The longer version is in <DocsLink slug="concepts/why-videojs">Why Video.js?</DocsLink>
...
Video.js 8 remains documented at [legacy.videojs.org](https://legacy.videojs.org). If you're looking to upgrade to newer versions, start with <DocsLink slug="how-to/migrate-from-video-js-8">Migrate from Video.js 8</DocsLink>.
...
<DocsLinkCard slug="how-to/build-with-ai" description="How to give AI tools the context they need to build Video.js players alongside you">Build with AI</DocsLinkCard>
