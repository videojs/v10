...
The default HLS video element, optimized for minimal bundle size. [HlsJsVideo](/docs/framework/html/components/hlsjs-video/) is the larger, more compatible alternative.
