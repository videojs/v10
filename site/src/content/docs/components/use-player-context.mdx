...
| Need                       | Hook                                                                                |
| -------------------------- | ----------------------------------------------------------------------------------- |
| Store access with selector | <DocsLink slug="components/use-player">`usePlayer`</DocsLink>                        |
| Current media element      | <DocsLink slug="components/use-media">`useMedia`</DocsLink>                          |
| Attach custom media        | <DocsLink slug="components/use-media-attach">`useMediaAttach`</DocsLink> |
