...
The live presets do not include the <DocsLink slug="reference/feature-stream-type">stream type feature</DocsLink>, so `selectStreamType` returns `undefined` unless you add it to a custom player.
