...
<DocsLinkCard slug="api/html-create-player">`createPlayer` reference</DocsLinkCard>
</FrameworkCase>
...
<DocsLinkCard slug="api/use-player">usePlayer reference</DocsLinkCard>
</FrameworkCase>
<FrameworkCase frameworks={["html"]}>
...
<DocsLinkCard slug="api/player-controller">PlayerController reference</DocsLinkCard>
</FrameworkCase>
