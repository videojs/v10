...
The folder is the type. The site derives each page's type from its path, shows it in the eyebrow above the title (for example "Guide · Playback"), and exposes it to search and llms.txt.
