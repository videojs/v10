...
Create `site/src/content/docs/components/{name}.mdx` with this structure:
...
**Util pages:**
- <DocsLink slug="components/use-player">usePlayer</DocsLink> — React hook, multi-overload
- <DocsLink slug="components/player-controller">PlayerController</DocsLink> — HTML controller
