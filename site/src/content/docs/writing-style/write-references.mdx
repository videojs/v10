...
This guide covers how to create API reference pages — component references, media references, and util references (hooks, controllers, mixins) under `components/` in the docs sidebar.
...
**Component pages:**
- <DocsLink slug="components/play-button">PlayButton</DocsLink> — single-part, interactive
- <DocsLink slug="components/controls">Controls</DocsLink> — behavior-heavy (auto-hide)
- <DocsLink slug="components/time">Time</DocsLink> — multi-part, formatting

**Util pages:**
- <DocsLink slug="api/use-player">usePlayer</DocsLink> — React hook, multi-overload
- <DocsLink slug="api/player-controller">PlayerController</DocsLink> — HTML controller
