...
The component renders only those package imports. UI components have no per-component CDN bundle, and that story belongs to the <DocsLink slug="concepts/cdn">CDN</DocsLink> concept, so individual pages never make CDN claims of their own.
