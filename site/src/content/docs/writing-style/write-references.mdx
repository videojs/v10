...
Create the page under `site/src/content/docs/components/` for a UI, skin, media, or extension component, or under `site/src/content/docs/api/` for a hook, feature, controller, factory, or utility. The file is `{name}.mdx` with this structure:
...
```ts
{
  ...
  contents: [
    ...
    { slug: 'components/your-component' }, // add here
  ],
},
```
