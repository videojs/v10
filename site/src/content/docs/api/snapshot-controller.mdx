...
|                | `SnapshotController`           | <DocsLink slug="api/store-controller">`StoreController`</DocsLink> |
| -------------- | ------------------------------ | ------------------------------------------------------------------------ |
...
<DocsLink slug="api/store-controller">`StoreController`</DocsLink> is
...
`SnapshotController` subscribes on `hostConnected()` and unsubscribes on `hostDisconnected()`. The React equivalent is <DocsLink slug="api/use-snapshot">`useSnapshot`</DocsLink>.
