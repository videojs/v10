...
Keys are nested semantic names such as `buttons.play` and `buttons.pause`. See <DocsLink slug="api/translation-phrases">Translation keys</DocsLink> for the complete catalog.
