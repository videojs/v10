...
| Need                       | Hook                                                                                |
| -------------------------- | ----------------------------------------------------------------------------------- |
| Store access with selector | <DocsLink slug="api/use-player">`usePlayer`</DocsLink>                        |
| Current media element      | <DocsLink slug="api/use-media">`useMedia`</DocsLink>                          |
| Attach custom media        | <DocsLink slug="api/use-media-attach">`useMediaAttach`</DocsLink> |
