...
<DocsLinkCard slug="guides/cast-to-airplay-and-chromecast">Cast to AirPlay and Chromecast</DocsLinkCard>

## Import

<FeatureImports feature="remotePlayback" />
...
Pass `selectRemotePlayback` to <DocsLink slug="reference/api/use-player">`usePlayer`</DocsLink> to subscribe to remote playback state. Returns `undefined` if the remote playback feature is not configured.
</FrameworkCase>

<FrameworkCase frameworks={["html"]}>
Pass `selectRemotePlayback` to <DocsLink slug="reference/api/player-controller">`PlayerController`</DocsLink> to subscribe to remote playback state. Returns `undefined` if the remote playback feature is not configured.
</FrameworkCase>
