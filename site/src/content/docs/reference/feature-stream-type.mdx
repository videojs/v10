...
Add `streamTypeFeature` to a custom player when you need `streamType` in player state. The live presets separately include the <DocsLink slug="reference/feature-live">live feature</DocsLink>, which tracks the live edge.
