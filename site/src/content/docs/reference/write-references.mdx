...
Extension reference pages document the <DocsLink slug="concepts/extensions">extensions</DocsLink> that add optional behavior to a player's media, such as Google Cast and Mux Data. They are hand-authored today: no generator produces their API tables.
