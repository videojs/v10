...
class VideoPlayer extends ProviderMixin(ContainerMixin(UIElement)) {}
```
...
class PlayerShell extends ProviderMixin(UIElement) {}

// Container registers as the layout/fullscreen target
class MediaRegion extends ContainerMixin(UIElement) {}
```
