...
HLS video element powered by [hls.js](https://github.com/video-dev/hls.js/) for adaptive bitrate streaming, with full feature support across every browser. It's more compatible than the default <DocsLink slug="reference/components/hls-video">HLS video component</DocsLink>, which is smaller and covers most HLS playback. For browser-native playback, see the <DocsLink slug="reference/components/native-hls-video">native HLS video component</DocsLink>.
