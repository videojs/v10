...
Adds the <DocsLink slug="guides/overview">Google Cast extension</DocsLink> to the player's media. It renders nothing — place it inside the player as a sibling of the media element, and pair it with a <DocsLink slug="reference/components/cast-button">CastButton</DocsLink>. See <DocsLink slug="guides/cast-to-airplay-and-chromecast">Cast to AirPlay and Chromecast</DocsLink> for the complete setup.
