...
frameworkTitle:
  html: google-cast
description: Options for the Google Cast extension that configures the receiver and load request
---

import FrameworkCase from '@/components/docs/FrameworkCase.astro';
import DocsLink from '@/components/docs/DocsLink.astro';
import DocsLinkCard from '@/components/docs/DocsLinkCard.astro';
import ExtensionImports from '@/components/docs/api-reference/ExtensionImports.astro';

Adds the <DocsLink slug="guides/architecture">Google Cast extension</DocsLink> to the player. It renders nothing — place it anywhere inside the player, and pair it with a <DocsLink slug="reference/components/cast-button">CastButton</DocsLink>. It follows whatever media the player attaches, a plain `<video>` included. See <DocsLink slug="guides/casting">Cast to AirPlay and Chromecast</DocsLink> for the complete setup.

## Import

<ExtensionImports extension="google-cast" package="@videojs/google-cast" react="GoogleCast" />
...
<DocsLinkCard slug="guides/casting" description="Add remote playback to a player">Cast to AirPlay and Chromecast</DocsLinkCard>
<DocsLinkCard slug="reference/components/cast-button">CastButton component reference</DocsLinkCard>
<DocsLinkCard slug="reference/api/feature-remote-playback">Remote Playback feature reference</DocsLinkCard>
