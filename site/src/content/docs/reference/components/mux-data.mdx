...
frameworkTitle:
  html: mux-data
description: Options for the Mux Data extension that monitors playback quality
---
...
Adds the [Mux Data](https://data.mux.com) <DocsLink slug="guides/architecture">extension</DocsLink> to the player's media. It renders nothing — place it inside the player as a sibling of the media element. See <DocsLink slug="guides/monitor-playback-with-mux-data">Mux Data</DocsLink> for how monitoring works.

## Import

<ExtensionImports extension="mux-data" package="@videojs/mux-data" react="MuxData" />
...
<DocsLinkCard slug="guides/monitor-playback-with-mux-data" description="How monitoring works">Mux Data</DocsLinkCard>
