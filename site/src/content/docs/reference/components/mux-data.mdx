...
<DocsLinkCard slug="reference/components/mux-video">Mux video reference</DocsLinkCard>
<DocsLinkCard slug="reference/components/mux-audio">Mux audio reference</DocsLinkCard>
