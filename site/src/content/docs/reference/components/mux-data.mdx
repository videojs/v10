...
Adds the [Mux Data](https://data.mux.com) <DocsLink slug="concepts/overview">extension</DocsLink> to the player's media. It renders nothing — place it inside the player as a sibling of the media element. See <DocsLink slug="guides/monitor-playback-with-mux-data">Mux Data</DocsLink> for how monitoring works.
