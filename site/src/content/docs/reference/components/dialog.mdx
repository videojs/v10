...
<ComponentImports component="Dialog" html={["dialog", "dialog-backdrop", "dialog-popup", "dialog-title", "dialog-description", "dialog-close"]} />
...
<FrameworkCase frameworks={["react"]}>
Use <DocsLink slug="reference/components/alert-dialog">`AlertDialog`</DocsLink> for urgent messages that require acknowledgement. <DocsLink slug="reference/components/error-dialog">`ErrorDialog`</DocsLink> is the player-error specialization. Both use the same dialog behavior.
</FrameworkCase>

<FrameworkCase frameworks={["html"]}>
Use <DocsLink slug="reference/components/alert-dialog">`<media-alert-dialog>`</DocsLink> for urgent messages that require acknowledgement. <DocsLink slug="reference/components/error-dialog">`<media-error-dialog>`</DocsLink> is the player-error specialization. Both use the same dialog behavior.
</FrameworkCase>
