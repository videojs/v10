...
The minimal skin of the video preset: the same player and the same controls in a visually lighter design, closer to a classic control bar. The <DocsLink slug="reference/components/video-skin">default video skin</DocsLink> is the same preset's other variant. See <DocsLink slug="guides/skins">Skins</DocsLink> for how packaged skins work and <DocsLink slug="guides/presets">Presets</DocsLink> for what the video preset ships.
