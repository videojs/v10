...
The default HLS video element, optimized for minimal bundle size. <DocsLink slug="reference/components/hlsjs-video">HlsJsVideo</DocsLink> is the larger, more compatible alternative.
