...
The lightweight HLS video element, optimized for minimal bundle size. The <DocsLink slug="reference/components/hlsjs-video">hls.js video component</DocsLink> is the larger, more compatible alternative.
