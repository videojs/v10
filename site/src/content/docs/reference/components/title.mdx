...
The component renders the resolved title directly as text and owns that text on both
platforms: React does not accept `children`, and the HTML element replaces any authored
content whenever the title updates. Set the title on the player instead.
