...
<FrameworkCase frameworks={["html"]}>
The element renders the resolved title directly as text and owns that text: it replaces
any authored content whenever the title updates. Set the title on the player instead.
</FrameworkCase>
