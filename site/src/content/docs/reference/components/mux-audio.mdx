...
<DocsLinkCard slug="guides/mux-data">Mux Data — metadata, options, and configuration</DocsLinkCard>
<DocsLinkCard slug="guides/casting">Cast to AirPlay and Chromecast</DocsLinkCard>
