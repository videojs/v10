...
<ComponentImports component="VolumePopover" html={["volume-popover", "mute-button", "volume-slider", "slider-track", "slider-fill", "slider-thumb"]} />
