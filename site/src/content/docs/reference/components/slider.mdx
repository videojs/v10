...
<ComponentImports component="Slider" html={["slider", "slider-track", "slider-fill", "slider-thumb", "slider-preview", "slider-thumbnail", "slider-value"]} />
...
The base slider provides a generic range input. It manages value, pointer tracking, and drag interactions. The <DocsLink slug="reference/components/time-slider">time slider</DocsLink> and <DocsLink slug="reference/components/volume-slider">volume slider</DocsLink> add media-specific bindings. The time slider also provides parts for rendering chapter ranges and the chapter at the current interaction position.
