...
import jsonReactCss from "@/components/docs/demos/thumbnail/react/css/JsonUsage.css?raw";
...
import jsonSpriteReactCss from "@/components/docs/demos/thumbnail/react/css/JsonSpriteUsage.css?raw";
...
import jsonHtmlCss from "@/components/docs/demos/thumbnail/html/css/JsonUsage.css?raw";
...
import jsonSpriteHtmlCss from "@/components/docs/demos/thumbnail/html/css/JsonSpriteUsage.css?raw";
...
In React, `Thumbnail` always reads player context, so JSON examples still use `Player.Provider` even when no media/track is involved.
  ...
  <StyleCase styles={["css"]}>
    <Demo
      files={[
        ...
        { title: "App.css", code: jsonReactCss, lang: "css" },
      ]}
    >
  ...
  <StyleCase styles={["css"]}>
    <Demo
      files={[
        ...
        { title: "index.css", code: jsonHtmlCss, lang: "css" },
  ...
  <StyleCase styles={["css"]}>
    <Demo
      files={[
        ...
        { title: "App.css", code: jsonSpriteReactCss, lang: "css" },
      ]}
    >
  ...
  <StyleCase styles={["css"]}>
    <Demo
      files={[
        ...
        { title: "index.css", code: jsonSpriteHtmlCss, lang: "css" },
