...
Add a <DocsLink slug="reference/components/pip-button">PiPButton</DocsLink>. It requests and exits picture-in-picture, reflects the current state, and renders nothing when picture-in-picture is unsupported.
</FrameworkCase>

<FrameworkCase frameworks={["html"]}>
Add a <DocsLink slug="reference/components/pip-button">`<media-pip-button>`</DocsLink>. It requests and exits picture-in-picture, reflects the current state, and renders nothing when picture-in-picture is unsupported.
</FrameworkCase>
...
The <DocsLink slug="reference/api/feature-pip">picture-in-picture feature</DocsLink> puts three things in player state.
...
- <DocsLink slug="reference/components/pip-button">PiP button</DocsLink>

## Related API

- <DocsLink slug="reference/api/feature-pip">Picture-in-picture feature</DocsLink>

## Related guides

- <DocsLink slug="guides/fullscreen">Go fullscreen and lock orientation</DocsLink>
