...
The old `npx @videojs/cli docs` workflow was removed. Use the `agents init` command from the React or HTML package so the instruction renderer ships with the player version.
