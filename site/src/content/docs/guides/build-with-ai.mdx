...
2. **`Accept: text/markdown` header**: AI tools that send this header when fetching a Video.js doc URL will receive markdown instead of HTML. The same page is about 250 KB as HTML and about 4 KB as Markdown.
   ...
   curl -H "Accept: text/markdown" \
     https://videojs.org/docs/framework/react/components/play-button
   ```
   ...
   ```
   ````
3. **Add `.md` to any URL**: append `.md` to any doc URL to get its markdown directly. For example, the PlayButton reference is available at [`videojs.org/docs/framework/react/components/play-button.md`](https://videojs.org/docs/framework/react/components/play-button.md). Every doc page also advertises this twin in its HTML head with `<link rel="alternate" type="text/markdown">`, so tools that look for it will find it.
</FrameworkCase>
...
2. **`Accept: text/markdown` header**: AI tools that send this header when fetching a Video.js doc URL will receive markdown instead of HTML. The same page is about 250 KB as HTML and about 4 KB as Markdown.
   ...
   ```bash title="Terminal"
   curl -H "Accept: text/markdown" \
     https://videojs.org/docs/framework/html/components/play-button
   ```
   ...
   ```
   ````
3. **Add `.md` to any URL**: append `.md` to any doc URL to get its markdown directly. For example, the PlayButton reference is available at [`videojs.org/docs/framework/html/components/play-button.md`](https://videojs.org/docs/framework/html/components/play-button.md). Every doc page also advertises this twin in its HTML head with `<link rel="alternate" type="text/markdown">`, so tools that look for it will find it.
</FrameworkCase>
