...
import SkillInstallSteps from '@/components/installation/SkillInstallSteps.astro';
...
<SkillInstallSteps agent="codex" />

#### Claude Code

<SkillInstallSteps agent="claude-code" />

#### VS Code

<SkillInstallSteps agent="vscode" />

#### Cursor

<SkillInstallSteps agent="cursor" />

#### Other coding agents

<SkillInstallSteps agent="other" />
