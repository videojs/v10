...
3. **Live docs.** If Video.js is not installed yet, or the project uses the CDN, the skill starts at [`videojs.org/docs/guides/installation.md`](https://videojs.org/docs/guides/installation.md), then requests the selected installation page and query parameters as Markdown.
