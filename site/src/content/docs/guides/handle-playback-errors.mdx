...
Render an <DocsLink slug="components/error-dialog">ErrorDialog</DocsLink> inside the player container. It reads error state, presents the failure, and dismisses cleanly. The prebuilt skins include one.
...
The <DocsLink slug="components/feature-error">error feature</DocsLink> mirrors the media element's error into player state:
...
- <DocsLink slug="components/feature-error">Error feature</DocsLink>
