...
The <DocsLink slug="api/feature-error">error feature</DocsLink> mirrors the media element's error into player state:
...
- <DocsLink slug="api/feature-error">Error feature</DocsLink>
