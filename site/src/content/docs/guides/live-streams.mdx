...
<FrameworkCase frameworks={["react"]}>
The examples use <DocsLink slug="reference/components/hlsjs-video">`HlsJsVideo`</DocsLink>, but any streaming media component works here, including the smaller default <DocsLink slug="reference/components/hls-video">`HlsVideo`</DocsLink>. Start with the default and switch engines only if your stream needs it.
</FrameworkCase>

<FrameworkCase frameworks={["html"]}>
The examples use <DocsLink slug="reference/components/hlsjs-video">`<hlsjs-video>`</DocsLink>, but any streaming media component works here, including the smaller default <DocsLink slug="reference/components/hls-video">`<hls-video>`</DocsLink>. Start with the default and switch engines only if your stream needs it.
</FrameworkCase>
