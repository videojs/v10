...
The <DocsLink slug="api/feature-remote-playback">remote playback feature</DocsLink> gives AirPlay and Google Cast one state shape:
...
- <DocsLink slug="api/feature-remote-playback">Remote playback feature</DocsLink>
