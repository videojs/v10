...
Use the <DocsLink slug="components/google-cast">GoogleCast extension</DocsLink> with a <DocsLink slug="components/cast-button">CastButton</DocsLink>, and add an <DocsLink slug="components/airplay-button">AirPlayButton</DocsLink> for Safari. The prebuilt skins already include both buttons; add `GoogleCast` next to a streaming media component to enable the configurable Cast route.
...
The <DocsLink slug="components/feature-remote-playback">remote playback feature</DocsLink> gives AirPlay and Google Cast one state shape:
...
- <DocsLink slug="components/cast-button">Cast button</DocsLink>
- <DocsLink slug="components/airplay-button">AirPlay button</DocsLink>
- <DocsLink slug="components/google-cast">GoogleCast</DocsLink>

## Related API

- <DocsLink slug="components/feature-remote-playback">Remote playback feature</DocsLink>
