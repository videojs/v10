...
<DocsLink slug="reference/api/use-quality-options">`useQualityOptions`</DocsLink> turns this state into ready-made menu options — labels like "1080p", an "Auto" entry, and `availability` — as shown in the demo above.

</FrameworkCase>
<FrameworkCase frameworks={["html"]}>

<DocsLink slug="reference/components/quality-radio-group">`<media-quality-radio-group>`</DocsLink> turns this state into a ready-made radio menu with resolution labels and an "Auto" entry, as shown in the demo above.
