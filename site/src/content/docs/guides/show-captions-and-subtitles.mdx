...
- <DocsLink slug="reference/api/use-captions-options">useCaptionsOptions</DocsLink>

## Related guides

- <DocsLink slug="guides/show-timeline-thumbnail-previews">Show timeline thumbnail previews</DocsLink>
