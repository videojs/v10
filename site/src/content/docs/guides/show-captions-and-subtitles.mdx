...
The <DocsLink slug="api/feature-text-tracks">text track feature</DocsLink> mirrors the media element's `textTracks` into player state:
...
- <DocsLink slug="api/use-captions-options">useCaptionsOptions</DocsLink>
