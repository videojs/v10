...
Add WebVTT tracks as `<track>` children of the media element, and give users a <DocsLink slug="components/captions-button">CaptionsButton</DocsLink> to toggle them.
...
The <DocsLink slug="components/feature-text-tracks">text track feature</DocsLink> mirrors the media element's `textTracks` into player state:
...
See the <DocsLink slug="components/captions-radio-group">CaptionsRadioGroup</DocsLink> reference for the complete pattern.

</FrameworkCase>
<FrameworkCase frameworks={["html"]}>

Use <DocsLink slug="components/captions-radio-group">`<media-captions-radio-group>`</DocsLink> inside a menu or popover for explicit track selection.
...
- <DocsLink slug="components/captions-button">Captions button</DocsLink>
- <DocsLink slug="components/captions-radio-group">Captions radio group</DocsLink>
- <DocsLink slug="components/menu">Menu</DocsLink>

## Related API

- <DocsLink slug="components/feature-text-tracks">Text track feature</DocsLink>
- <DocsLink slug="components/use-captions-options">useCaptionsOptions</DocsLink>
