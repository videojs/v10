...
The <DocsLink slug="components/feature-quality">quality feature</DocsLink> mirrors the media element's video renditions into player state:
...
<DocsLink slug="components/use-quality-options">`useQualityOptions`</DocsLink> turns this state into ready-made menu options — labels like "1080p", an "Auto" entry, and `availability` — as shown in the demo above.

</FrameworkCase>
<FrameworkCase frameworks={["html"]}>

<DocsLink slug="components/quality-radio-group">`<media-quality-radio-group>`</DocsLink> turns this state into a ready-made radio menu with resolution labels and an "Auto" entry, as shown in the demo above.
...
Access the player store through the <DocsLink slug="components/player-controller">player controller</DocsLink> and call `selectVideoRendition` with a rendition `id` from `videoRenditionList`, or `'auto'` to restore adaptive selection.
...
- <DocsLink slug="components/quality-radio-group">Quality radio group</DocsLink>
- <DocsLink slug="components/menu">Menu</DocsLink>

## Related API

- <DocsLink slug="components/feature-quality">Quality feature</DocsLink>
- <DocsLink slug="components/use-quality-options">useQualityOptions</DocsLink>
- <DocsLink slug="components/hls-video">HlsVideo</DocsLink>
- <DocsLink slug="components/hlsjs-video">HlsJsVideo</DocsLink>
- <DocsLink slug="components/dash-video">DashVideo</DocsLink>
