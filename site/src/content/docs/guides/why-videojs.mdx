...
We don't want to cram every possible player into one configuration API. Packaged skins cover common visual changes. For everything else, copy the skin files into your project and compose the UI you need.
