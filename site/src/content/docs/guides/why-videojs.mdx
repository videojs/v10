...
<DocsLinkCard slug="guides/architecture">Learn more about the architecture</DocsLinkCard>

### Video interactions

Video often involves more than an MP4 in `src`. Features like thumbnail previews, adaptive bitrate, quality selection, chapters, audio track switching, localized controls, error UI, live-streaming UI, AirPlay, and DRM are _possible_ with the video element, but require complex wiring and careful work on maintainability and <DocsLink slug="guides/accessibility">accessibility</DocsLink>.
...
<DocsLinkCard slug="guides/features">Learn more about features</DocsLinkCard>
...
<DocsLinkCard slug="guides/customize-skins" anchor="style-skin-source">Customize skins</DocsLinkCard>
...
<DocsLinkCard slug="guides/build-with-ai">Build with AI</DocsLinkCard>
