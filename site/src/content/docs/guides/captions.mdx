...
Add WebVTT tracks as `<track>` children of the media element, and give users a <DocsLink slug="reference/components/captions-button">CaptionsButton</DocsLink> to toggle them.
</FrameworkCase>

<FrameworkCase frameworks={["html"]}>
Add WebVTT tracks as `<track>` children of the media element, and give users a <DocsLink slug="reference/components/captions-button">`<media-captions-button>`</DocsLink> to toggle them.
</FrameworkCase>
...
The <DocsLink slug="reference/api/feature-text-tracks">text track feature</DocsLink> mirrors the media element's `textTracks` into player state:
...
See the <DocsLink slug="reference/components/captions-radio-group">CaptionsRadioGroup</DocsLink> reference for the complete pattern.

</FrameworkCase>
<FrameworkCase frameworks={["html"]}>

Use <DocsLink slug="reference/components/captions-radio-group">`<media-captions-radio-group>`</DocsLink> inside a menu or popover for explicit track selection.
...
- <DocsLink slug="reference/components/captions-button">Captions button</DocsLink>
- <DocsLink slug="reference/components/captions-radio-group">Captions radio group</DocsLink>
- <DocsLink slug="reference/components/menu">Menu</DocsLink>

## Related API

- <DocsLink slug="reference/api/feature-text-tracks">Text track feature</DocsLink>
- <DocsLink slug="reference/api/use-captions-options" frameworks="react">useCaptionsOptions</DocsLink>

## Related guides

- <DocsLink slug="guides/thumbnails">Show timeline thumbnail previews</DocsLink>
