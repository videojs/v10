...
If you have a progressive MP4 or WebM file instead of an HLS stream, `BackgroundVideo` is the same component without the streaming engine. See <DocsLink slug="reference/components/background-video">BackgroundVideo</DocsLink> for opt-out attributes and sizing.
