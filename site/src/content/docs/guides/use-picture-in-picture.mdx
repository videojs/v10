...
Add a <DocsLink slug="components/pip-button">PiPButton</DocsLink>. It requests and exits picture-in-picture, reflects the current state, and renders nothing when picture-in-picture is unsupported.
...
The <DocsLink slug="components/feature-pip">picture-in-picture feature</DocsLink> puts three things in player state.
...
- <DocsLink slug="components/pip-button">PiP button</DocsLink>

## Related API

- <DocsLink slug="components/feature-pip">Picture-in-picture feature</DocsLink>
