...
The <DocsLink slug="components/feature-controls">controls feature</DocsLink> tracks activity on the player container:
...
- <DocsLink slug="components/feature-controls">Controls feature</DocsLink>
