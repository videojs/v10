...
Use the skin gestures (`tap` with the `toggleControls` action) rather than adding your own tap handlers next to the built-in behavior; competing handlers invert each other. See <DocsLink slug="guides/add-keyboard-shortcuts-and-gestures">Add keyboard shortcuts and gestures</DocsLink>.
...
- <DocsLink slug="guides/add-keyboard-shortcuts-and-gestures">Add keyboard shortcuts and gestures</DocsLink>
