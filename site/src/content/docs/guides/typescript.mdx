...
Video.js packages define their supported import paths using <DocsLink slug="guides/bundlers">package exports</DocsLink>. Most web applications should use the following configuration. It makes TypeScript follow the same package rules as the bundler that builds the application:
