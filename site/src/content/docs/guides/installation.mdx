...
Answer the questions below and the install and usage code further down updates to match.
...
This guide uses <DocsLink slug="components/hlsjs-video">HlsJsVideo</DocsLink> for broad compatibility. To experiment with our lightweight HLS engine and reduce your bundle size, try <DocsLink slug="components/hls-video">HlsVideo</DocsLink>.
</Aside>
</MediaSourceCase>
