...
4. **Keep it working in an <DocsLink slug="guides/customize-skins" anchor="eject-and-edit-a-skin">ejected skin</DocsLink>.** The player's `poster` still reaches the Poster component your skin renders, or you can set the image's source yourself.
...
Ejecting a skin changes nothing about the first two approaches: the player's `poster`, or the poster the media provides, still reaches the <DocsLink slug="reference/components/poster">Poster</DocsLink> component your skin renders.
