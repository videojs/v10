...
4. **Keep it working after <DocsLink slug="guides/customize-skins" anchor="style-skin-source">adding the skin source to your project</DocsLink>.** The player's `poster` still reaches the Poster component your skin renders, or you can set the image's source yourself.
...
<FrameworkCase frameworks={["react"]}>
If you use a ready-made skin, it includes <DocsLink slug="reference/components/poster">Poster</DocsLink> and shows the image automatically. If you build your own UI, add Poster yourself. It hides after the user plays or seeks.
</FrameworkCase>

<FrameworkCase frameworks={["html"]}>
If you use a ready-made skin, it includes <DocsLink slug="reference/components/poster">`<media-poster>`</DocsLink> and shows the image automatically. If you build your own UI, add `<media-poster>` yourself. It hides after the user plays or seeks.
</FrameworkCase>

When the player and the media component both choose a poster, the player's `poster` wins. See <DocsLink slug="reference/api/feature-metadata">Metadata</DocsLink> for how the player combines those values.
...
<FrameworkCase frameworks={["react"]}>
Adding the skin source to your project changes nothing about the first two approaches: the player's `poster`, or the poster the media provides, still reaches the <DocsLink slug="reference/components/poster">Poster</DocsLink> component your skin renders.
</FrameworkCase>

<FrameworkCase frameworks={["html"]}>
Adding the skin source to your project changes nothing about the first two approaches: the player's `poster`, or the poster the media provides, still reaches the <DocsLink slug="reference/components/poster">`<media-poster>`</DocsLink> element your skin renders.
</FrameworkCase>
...
- <DocsLink slug="reference/components/poster">Poster</DocsLink>

## Related API

- <DocsLink slug="reference/api/feature-metadata">Metadata</DocsLink>

## Related guides

- <DocsLink slug="guides/customize-skins" anchor="style-a-packaged-skin">Customize skins</DocsLink>
