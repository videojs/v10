...
## Set the poster after copying the skin files

Adding the skin files to your project changes nothing about the first two approaches: the player's `poster`, or the poster the media provides, still reaches the <DocsLink slug="reference/components/poster">Poster</DocsLink> component your skin renders.
