...
- <DocsLink slug="guides/add-a-poster-and-loading-placeholder">Add a poster and loading placeholder</DocsLink>
- <DocsLink slug="guides/show-captions-and-subtitles">Show captions and subtitles</DocsLink>
