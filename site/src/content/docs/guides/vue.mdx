...
Scoped styles cannot reach controls inside a packaged skin. Use its CSS custom properties, or <DocsLink slug="guides/customize-skins" anchor="style-skin-source">add the skin source to your project</DocsLink> to change its markup and CSS.
