...
- **The UI is composable.** Buttons, sliders, menus, gestures, and hotkeys are individual accessible components. Start with the Minimal or Default skin, then [copy its files into your project](#edit-skin-source) when you need to change the structure.
...
| `clickToPlay` | Preset video skins include click and tap gestures. [Add the skin files to your project](#edit-skin-source) to remove or change them. |
| `keyboard` | Preset video skins include common hotkeys. [Add the skin files to your project](#edit-skin-source) to remove or change them. |
| `tooltips` | Preset skins include tooltips for common controls. [Add the skin files to your project](#edit-skin-source) to customize them. |
...
Plyr's `controls` option chooses which controls appear. Video.js skins come with their own control set and layout. Keep the skin when that UI fits your player. To remove, reorder, or restyle its controls, [add the skin files to your project](#edit-skin-source) and edit them. Adding a child to a skin does not place it inside the control bar.
...
Video.js v10 skins offer similar color customization via CSS custom properties. [Add the skin files to your project](#edit-skin-source) when you need deeper control over layout, control structure, icons, or interaction styling.
