...
Use <DocsLink slug="components/background-video">BackgroundVideo</DocsLink> with an MP4 or WebM URL. Put the video and poster inside a wrapper with `aria-hidden="true"` because both are decorative. Keep the heading, links, and other page content outside that wrapper.
...
| Need | Use |
| --- | --- |
| Cross-browser HLS with a small background-only player | <DocsLink slug="components/hls-background-video">HlsBackgroundVideo</DocsLink> |
| The same background-only player for a Mux HLS URL | <DocsLink slug="components/mux-background-video">MuxBackgroundVideo</DocsLink> |
...
- <DocsLink slug="components/hls-background-video">HlsBackgroundVideo</DocsLink>
- <DocsLink slug="components/mux-background-video">MuxBackgroundVideo</DocsLink>
