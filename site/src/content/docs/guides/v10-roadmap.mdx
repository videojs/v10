...
- Developers encouraged to follow the <DocsLink slug="guides/installation">installation guide</DocsLink>, try it out, and report issues
...
- Community encouraged to begin full reintegration projects, following the migration guides for <DocsLink slug="guides/migrate-from-video-js-8">Video.js 8</DocsLink>, <DocsLink slug="guides/migrate-from-mux-player">Mux Player</DocsLink>, <DocsLink slug="guides/migrate-from-plyr">Plyr</DocsLink>, and <DocsLink slug="guides/migrate-from-media-chrome">Media Chrome</DocsLink>
...
- <DocsLink slug="guides/why-videojs">Why Video.js?</DocsLink>
