...
- <DocsLink slug="reference/components/volume-slider">Volume slider</DocsLink>
...
- <DocsLink slug="reference/api/use-store" frameworks="react">useStore</DocsLink>
- <DocsLink slug="reference/api/player-controller" frameworks="html">PlayerController</DocsLink>
- <DocsLink slug="reference/api/store-controller" frameworks="html">StoreController</DocsLink>
...
- <DocsLink slug="guides/quality">Add a quality selector</DocsLink>
