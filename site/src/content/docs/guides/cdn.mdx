...
Shadcn adds source files and package dependencies, so this path uses a package manager and build step instead of CDN-only scripts.

## Related guides

- <DocsLink slug="guides/installation">Installation</DocsLink>
- <DocsLink slug="guides/self-hosting">Self-host the player</DocsLink>
- <DocsLink slug="guides/internationalization">Internationalize the player</DocsLink>
