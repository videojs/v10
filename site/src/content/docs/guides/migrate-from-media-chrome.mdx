...
| `--media-secondary-color`                           | no direct equivalent   | Add the skin files and author this palette role in your CSS.                                        |
| `--media-control-background`                        | no direct equivalent   | Add the skin files and author the CSS.                                                              |
| `--media-control-hover-background`                  | no direct equivalent   | Add the skin files and author the CSS.                                                              |
| `--media-range-track-height`                        | no direct equivalent   | Add the skin files and author the slider CSS.                                                       |
...
Keep the skin when its CSS variables and content slots cover your changes. Build a custom control bar when you want to start from scratch. Add the skin files to your project when you want its existing layout and styles but need to change the controls inside it.
</FrameworkCase>
