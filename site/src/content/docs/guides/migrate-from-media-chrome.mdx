...
| `lang` | i18n translator | Localization is configured through the <DocsLink slug="guides/internationalize-the-player">translator and locale registry</DocsLink>. |
...
<FrameworkCase frameworks={["react"]}>
React skins do not use Shadow DOM. Use `render` props when you build individual controls. Install a ready-made skin's source when you need to change its control set or layout.
</FrameworkCase>
