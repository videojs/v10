...
Follow the <DocsLink slug="guides/installation">installation guide</DocsLink> first. Keep its `@videojs/html` imports and player markup in your Vue component, then apply the Vue-specific configuration below.
...
Scoped styles cannot reach controls inside a packaged skin. Use its CSS custom properties, or <DocsLink slug="guides/customize-skins" anchor="eject-and-edit-a-skin">eject the skin</DocsLink> to change its markup and CSS.
...
- <DocsLink slug="guides/installation-vue">Installation</DocsLink>
- <DocsLink slug="guides/customize-skins">Customize skins</DocsLink>
- <DocsLink slug="concepts/custom-element-lifecycle">Custom element lifecycle</DocsLink>
