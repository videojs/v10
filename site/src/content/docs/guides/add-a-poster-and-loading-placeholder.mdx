...
When the player and the media component both choose a poster, the player's `poster` wins. See <DocsLink slug="api/feature-metadata">Metadata</DocsLink> for how the player combines those values.
...
- <DocsLink slug="api/feature-metadata">Metadata</DocsLink>
