...
- <DocsLink slug="reference/api/i18n-provider">I18nProvider</DocsLink>
- <DocsLink slug="reference/api/media-i18n">media-i18n</DocsLink>
- <DocsLink slug="reference/api/media-text">media-text</DocsLink>
...
- <DocsLink slug="reference/api/use-translator">useTranslator</DocsLink>
- <DocsLink slug="reference/api/use-locale">useLocale</DocsLink>
