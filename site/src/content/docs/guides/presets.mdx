...
<FrameworkCase frameworks={["react"]}>
Each React preset exports a named, preconfigured player component and typed `usePlayer` hook, plus the building blocks needed to extend its features, add its skin source to your project, or swap its media element:
