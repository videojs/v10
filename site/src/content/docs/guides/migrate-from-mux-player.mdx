...
An ejected or custom layout shows the title only where you place the component. Keep it inside the container so it overlays the media:
...
<VideoPlayer title="Test VOD">
  <Container className="player-surface">
    <MuxVideo source={{ playbackId: 'EcHgOK9coz5K…' }} />
    <Title />
  </Container>
</VideoPlayer>
