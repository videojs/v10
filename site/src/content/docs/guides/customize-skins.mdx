...
The media element and poster share `--media-object-fit` and `--media-object-position`, so a `cover` poster stays aligned with `cover` video. See <DocsLink slug="guides/add-a-poster-and-loading-placeholder">Add a poster and loading placeholder</DocsLink>.
...
To understand how skins fit into Video.js, read <DocsLink slug="concepts/skins">Skins</DocsLink>. To create a control instead of editing one, follow <DocsLink slug="guides/build-your-own-component">Build your own component</DocsLink>.
...
- <DocsLink slug="concepts/skins">Skins</DocsLink>
