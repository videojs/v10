...
| An extension's own settings | that extension's props | <DocsLink slug="concepts/mux-data">Mux Data</DocsLink>, <DocsLink slug="reference/components/google-cast">GoogleCast</DocsLink> |
...
| `config.muxData` | the <DocsLink slug="concepts/mux-data">Mux Data</DocsLink> extension's own props |
