...
| A side-car component's own settings | that component's props | <DocsLink slug="concepts/mux-data">Mux Data</DocsLink>, <DocsLink slug="reference/google-cast">GoogleCast</DocsLink> |
...
| `config.googleCast` | the <DocsLink slug="reference/google-cast">GoogleCast</DocsLink> component's own props |
