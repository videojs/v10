...
You can use a skin as one packaged component or eject its source into your project. It is usually easiest to start with the package and eject later, when you need more control.
...
<DocsLinkCard slug="how-to/customize-skins" anchor="eject-a-skin">Eject and customize a skin</DocsLinkCard>
