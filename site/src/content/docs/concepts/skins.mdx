...
Packaged skins cover common visual changes through documented CSS custom properties. When you need more than that, eject and change the components and styles directly.
...
Treat the packaged skin's internal markup, class names, and undocumented custom properties as implementation details.
