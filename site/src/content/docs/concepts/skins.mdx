...
Packaged skins cover common visual changes through documented CSS custom properties. Packaged video skins also have one poster replacement hook. They don't expose their internals as CSS parts or stable selectors. When you need more than that, eject and change the components and styles directly.
...
Treat the packaged skin's internal markup, class names, `data-part` markers, and undocumented custom properties as implementation details. In an ejected skin, those details become app code that you own.
