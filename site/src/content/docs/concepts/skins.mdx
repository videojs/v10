...
When you choose a skin, you have two options for how you use it: use the **packaged skin** or install its **editable source**. It's usually easiest to start with a packaged skin and install an editable copy in your project later, when you need more customization.
...
<DocsLinkCard slug="how-to/customize-skins" anchor="style-a-packaged-skin">Style a packaged skin</DocsLinkCard>
...
<DocsLinkCard slug="how-to/customize-skins" anchor="install-and-edit-a-skin">Install and edit a skin</DocsLinkCard>
