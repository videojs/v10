...
<FrameworkCase frameworks={["react"]}>
You access feature state and actions through <DocsLink slug="api/use-player">`usePlayer`</DocsLink>:
```tsx
...
<FrameworkCase frameworks={["html"]}>
You can access feature state and actions through <DocsLink slug="api/player-controller">`PlayerController`</DocsLink> and pre-built feature selectors (e.g. <DocsLink slug="api/feature-playback">`selectPlayback`</DocsLink>, <DocsLink slug="api/feature-volume">`selectVolume`</DocsLink>):
```ts
...
<FrameworkCase frameworks={["react"]}>
### Feature selectors
Each feature also has a pre-built selector (e.g. <DocsLink slug="api/feature-playback">`selectPlayback`</DocsLink>, <DocsLink slug="api/feature-volume">`selectVolume`</DocsLink>) that returns just that feature's state and actions:
