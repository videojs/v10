...
UI components can go anywhere inside a <DocsLink slug="components/player">`<Player>`</DocsLink>.
...
<DocsLinkCard slug="components/player-container">Read more about `<Container>`</DocsLinkCard>
</FrameworkCase>

<FrameworkCase frameworks={["html"]}>
UI components can go anywhere inside a <DocsLink slug="components/player">`<video-player>`</DocsLink>.
...
<DocsLinkCard slug="components/player-container">Read more about `<media-container>`</DocsLinkCard>
</FrameworkCase>
