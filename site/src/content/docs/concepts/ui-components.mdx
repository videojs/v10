...
The hooks documented on each component are public: the HTML element name, a React `className` you supply, state `data-*` attributes, and any listed CSS custom properties. This applies to components you compose yourself. It does not make a packaged skin's internal component tree or classnames public.
...
Here, a **part** is a component you compose, not a CSS shadow part exposed by a packaged skin.
