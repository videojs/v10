...
UI components can go anywhere inside a <DocsLink slug="reference/player">`<Player>`</DocsLink>.
...
UI components can go anywhere inside a <DocsLink slug="reference/player">`<video-player>`</DocsLink>.
