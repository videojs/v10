...
We don't want to cram every possible player into one configuration API. Packaged skins cover common visual changes. For everything else, eject early and compose the UI you need. The Shadcn CLI copies any skin from the Video.js registry into your project.
