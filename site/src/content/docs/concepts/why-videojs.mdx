---
title: 'Why Video.js?'
description: 'The open-source video player for React, HTML, and every framework that speaks HTML. Lightweight, accessible components built for performance and streaming.'
---
...
<TabsRoot client:idle>
  <TabsList client:idle label="Framework-native APIs">
    ...
    <Tab client:idle value="vue">Vue</Tab>
  ...
  <TabsPanel client:idle value="vue">
    ```vue
