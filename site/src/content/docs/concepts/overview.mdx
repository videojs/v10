...
The easiest way to get started is to <DocsLink slug="how-to/change-a-skins-controls-and-layout">install an editable copy of the closest skin</DocsLink> and use its styled components as a foundation.
