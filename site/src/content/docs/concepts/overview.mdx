...
The easiest way to get started is to <DocsLink slug="how-to/customize-skins" anchor="eject-and-edit-a-skin">eject the closest skin</DocsLink> and use its styled components as a foundation.
