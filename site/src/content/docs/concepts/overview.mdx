...
The easiest way to get started is to <DocsLink slug="how-to/customize-skins">install the closest skin's source</DocsLink> and use its pre-styled components as a foundation.
