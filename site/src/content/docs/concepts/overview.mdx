...
The easiest way to get started is to <DocsLink slug="how-to/customize-skins" anchor="install-and-edit-a-skin">install an editable copy of the closest skin</DocsLink> and use its styled components as a foundation.
