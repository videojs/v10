...
> Note: Compare this previous versions of Video.js where there was a single `player` component that included everything about the player under the hood.
...
<FrameworkCase frameworks={["html"]}>
- `<video-skin>` — The default skin
- `<minimal-video-skin>` — Clean, simple alternative
</FrameworkCase>
<FrameworkCase frameworks={["react"]}>
- `<VideoSkin>` — The default skin
- `<MinimalSkin>` — Clean, simple alternative
</FrameworkCase>
...
| Skin | `<VideoSkin>` — component import |
