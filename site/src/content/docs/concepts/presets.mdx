...
If a preset's skin is close but not quite right, <DocsLink slug="how-to/customize-skins" anchor="install-and-edit-a-skin">install an editable copy</DocsLink> and customize its components and styles.
