...
If a preset's skin is close but not quite right, you can <DocsLink slug="how-to/customize-skins">eject it</DocsLink>: install its source from the Shadcn registry and customize from there.
