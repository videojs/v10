...
If a preset's skin is close but not quite right, <DocsLink slug="how-to/customize-skins" anchor="eject-a-skin">eject it</DocsLink> and customize its components and styles.
