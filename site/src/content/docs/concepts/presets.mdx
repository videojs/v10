...
If a preset's skin is close but not quite right, <DocsLink slug="how-to/change-a-skins-controls-and-layout">eject it</DocsLink> and customize its components and styles.
