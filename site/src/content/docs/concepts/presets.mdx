...
If a preset's skin is close but not quite right, make it <DocsLink slug="how-to/customize-skins">Source-Owned UI</DocsLink>: install its source from the Shadcn registry and customize from there.
