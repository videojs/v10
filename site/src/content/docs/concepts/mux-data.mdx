...
The extension attaches to the media the player is using, not to a specific element type, so it monitors <DocsLink slug="components/mux-video">MuxVideo</DocsLink>, <DocsLink slug="components/hlsjs-video">HlsJsVideo</DocsLink>, <DocsLink slug="components/dash-video">DashVideo</DocsLink>, and the rest alike.
...
<DocsLinkCard slug="components/mux-data">MuxData reference</DocsLinkCard>
<DocsLinkCard slug="components/mux-video">MuxVideo element reference</DocsLinkCard>
<DocsLinkCard slug="components/mux-audio">MuxAudio element reference</DocsLinkCard>
