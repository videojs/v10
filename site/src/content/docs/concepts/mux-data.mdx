---
title: Mux Data
description: Monitor playback quality and viewer experience by adding the Mux Data extension to a player
---
...
[Mux Data](https://www.mux.com/data) measures playback quality: startup time, rebuffering, playback failures, and watch time. Add the Mux Data <DocsLink slug="concepts/overview">extension</DocsLink> to a player and it monitors whichever media that player is playing:
...
<DocsLinkCard slug="reference/components/mux-data">MuxData reference</DocsLinkCard>
<DocsLinkCard slug="reference/components/mux-video">MuxVideo element reference</DocsLinkCard>
<DocsLinkCard slug="reference/components/mux-audio">MuxAudio element reference</DocsLinkCard>
<DocsLinkCard slug="guides/cast-to-airplay-and-chromecast" description="Add Google Cast and AirPlay to a player">Cast to AirPlay and Chromecast</DocsLinkCard>
