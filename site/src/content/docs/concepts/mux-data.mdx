...
The extension attaches to the media the player is using, not to a specific element type, so it monitors <DocsLink slug="reference/mux-video">MuxVideo</DocsLink>, <DocsLink slug="reference/hlsjs-video">HlsJsVideo</DocsLink>, <DocsLink slug="reference/dash-video">DashVideo</DocsLink>, and the rest alike.
...
<DocsLinkCard slug="how-to/cast-to-airplay-and-chromecast" description="Add Google Cast and AirPlay to a player">Cast to AirPlay and Chromecast</DocsLinkCard>
