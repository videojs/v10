...
export default function App() {
  return (
    <Player.Provider>
      <Player.Container>
        <HlsVideo src="https://stream.mux.com/..." autoPlay muted playsInline loop />
        <CastButton />
      </Player.Container>
    </Player.Provider>
  );
...
<video-player>
  <media-container>
    <hls-video src="https://stream.mux.com/....m3u8" autoplay muted playsinline loop></hls-video>
...
<FrameworkCase frameworks={["react"]}>
```tsx
<HlsVideo src="..." castReceiver="YOUR_APP_ID" />
```
</FrameworkCase>
...
<FrameworkCase frameworks={["react"]}>
```tsx
<HlsVideo src="https://stream.mux.com/.../manifest.m3u8" castStreamType="live" />
```
</FrameworkCase>

<FrameworkCase frameworks={["html"]}>
```html
<hls-video src="https://stream.mux.com/.../manifest.m3u8" caststreamtype="live"></hls-video>
```
</FrameworkCase>
