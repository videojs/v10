...
To add, remove, or rearrange the skin you selected, eject it into your project. If your project does not have a `components.json` file, <DocsLink slug="how-to/customize-skins" anchor="set-up-the-shadcn-cli">set up the CLI first</DocsLink>. Then choose how you want the skin's styles written and run the command below to copy its files:

<RegistryStyling />

<InstallationRegistryCommand />

<DocsLinkCard slug="how-to/customize-skins" anchor="eject-and-edit-a-skin" description="Learn which files to edit and how to update your copy later">Customize skins</DocsLinkCard>

## Choose what to do next

<DocsLinkCard slug="how-to/customize-skins" anchor="style-a-packaged-skin" description="Change colors, typography, sizing, and poster presentation">Customize skins</DocsLinkCard>
