...
<FrameworkCase frameworks={["react"]}>
If a preset and skin do not meet your user's requirements, follow [Change a skin's controls and layout](/docs/framework/react/how-to/change-a-skins-controls-and-layout) to install an editable copy of the closest skin. As you develop with Video.js, rely heavily on [llms.txt](/docs/framework/react/llms.txt) to make sure you always have the latest information.
</FrameworkCase>
<FrameworkCase frameworks={["html"]}>
If a preset and skin do not meet your user's requirements, follow [Change a skin's controls and layout](/docs/framework/html/how-to/change-a-skins-controls-and-layout) to install an editable copy of the closest skin. As you develop with Video.js, rely heavily on [llms.txt](/docs/framework/html/llms.txt) to make sure you always have the latest information.
</FrameworkCase>
</LLMCase>
...
To add, remove, or rearrange the skin you selected, install its source in your project. If your project does not have a `components.json` file, <DocsLink slug="how-to/change-a-skins-controls-and-layout" anchor="set-up-the-shadcn-cli">set up the CLI first</DocsLink>. Then choose how you want the skin's styles written and run the command below to copy its files:

<RegistryStyling />

<InstallationRegistryCommand />

<DocsLinkCard slug="how-to/change-a-skins-controls-and-layout" description="Learn which files to edit and how to update your copy later">Change a skin's controls and layout</DocsLinkCard>

## Choose what to do next

<DocsLinkCard slug="how-to/style-a-packaged-skin" description="Change colors, typography, sizing, and poster presentation">Style a packaged skin</DocsLinkCard>
