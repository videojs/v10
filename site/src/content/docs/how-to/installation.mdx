...
<DocsLinkCard slug="getting-started/shadcn" description="Configure the registry, inspect items, and maintain source-owned files">Install editable Video.js source</DocsLinkCard>
