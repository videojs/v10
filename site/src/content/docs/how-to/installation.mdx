...
import EjectedSkinToggle from '@/components/installation/EjectedSkinToggle.astro';
...
Want full control over the skin? You can [eject it](#ejecting-a-skin) copy the source into your project and customize it freely.
