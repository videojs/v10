...
<FrameworkCase frameworks={["react"]}>
If a preset and skin do not meet your user's requirements, follow [Customize skins](/docs/framework/react/how-to/customize-skins#eject-a-skin) to eject the closest skin. As you develop with Video.js, rely heavily on [llms.txt](/docs/framework/react/llms.txt) to make sure you always have the latest information.
</FrameworkCase>
<FrameworkCase frameworks={["html"]}>
If a preset and skin do not meet your user's requirements, follow [Customize skins](/docs/framework/html/how-to/customize-skins#eject-a-skin) to eject the closest skin. As you develop with Video.js, rely heavily on [llms.txt](/docs/framework/html/llms.txt) to make sure you always have the latest information.
</FrameworkCase>
</LLMCase>
...
<DocsLinkCard slug="how-to/customize-skins" description="Choose packaged settings, an ejected skin, or a custom interface">Customize skins</DocsLinkCard>
