...
Video.js is a **React video player component library** &mdash; composable primitives, hooks, and TypeScript types. Reach for it when the `<video>` tag isn't enough: streaming formats like HLS, accessible controls that look the same across browsers, or a UI that matches the rest of your product. See <DocsLink slug="concepts/why-videojs">Why Video.js?</DocsLink> for the full case.
</FrameworkCase>
<FrameworkCase frameworks={["html"]}>
Video.js is an **HTML video player built on custom elements** &mdash; lightweight, framework-free components. Reach for it when the `<video>` tag isn't enough: streaming formats like HLS, accessible controls that look the same across browsers, or a UI that matches the rest of your product. See <DocsLink slug="concepts/why-videojs">Why Video.js?</DocsLink> for the full case.
</FrameworkCase>
