...
2. **`Accept: text/markdown` header**: AI tools that send this header when fetching a Video.js doc URL will receive markdown instead of HTML.
   ...
   <ContentWidth><Img src={markdownNegotiation} alt="Fetching a doc URL returns 188.7KB of HTML; fetching the same URL with the Accept: text/markdown header returns 3.4KB of markdown" class="w-full max-w-md" /></ContentWidth>
...
2. **`Accept: text/markdown` header**: AI tools that send this header when fetching a Video.js doc URL will receive markdown instead of HTML.
   ...
   <ContentWidth><Img src={markdownNegotiation} alt="Fetching a doc URL returns 188.7KB of HTML; fetching the same URL with the Accept: text/markdown header returns 3.4KB of markdown" class="w-full max-w-md" /></ContentWidth>
3. **Add `.md` to any URL**: append `.md` to any doc URL to get its markdown directly. For example, the PlayButton reference is available at [`videojs.org/docs/framework/vue/reference/play-button.md`](https://videojs.org/docs/framework/vue/reference/play-button.md).
</FrameworkCase>
...
2. **`Accept: text/markdown` header**: AI tools that send this header when fetching a Video.js doc URL will receive markdown instead of HTML.
   ...
   <ContentWidth><Img src={markdownNegotiation} alt="Fetching a doc URL returns 188.7KB of HTML; fetching the same URL with the Accept: text/markdown header returns 3.4KB of markdown" class="w-full max-w-md" /></ContentWidth>
3. **Add `.md` to any URL**: append `.md` to any doc URL to get its markdown directly. For example, the PlayButton reference is available at [`videojs.org/docs/framework/svelte/reference/play-button.md`](https://videojs.org/docs/framework/svelte/reference/play-button.md).
</FrameworkCase>
...
<FrameworkCase frameworks={["vue"]}>
[`videojs.org/docs/framework/vue/llms.txt`](https://videojs.org/docs/framework/vue/llms.txt) is an index of the full documentation: every page with a title and description. Add it to your project's context so your AI knows what's available.
</FrameworkCase>

<FrameworkCase frameworks={["svelte"]}>
[`videojs.org/docs/framework/svelte/llms.txt`](https://videojs.org/docs/framework/svelte/llms.txt) is an index of the full documentation: every page with a title and description. Add it to your project's context so your AI knows what's available.
</FrameworkCase>
