...
You can of course also add your own classnames to the skins themselves. The four properties above are the documented controls for styling packaged skins. For anything deeper, eject instead of relying on internal classnames or custom properties.
