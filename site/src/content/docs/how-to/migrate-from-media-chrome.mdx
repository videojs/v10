...
Media Chrome theme variables do not carry over by name. Use the packaged skin's documented CSS custom properties for common visual changes. If your theme changes control visibility, layout, overlays, icons, or interactions, eject the closest skin and edit it directly.
