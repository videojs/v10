...
| `--media-secondary-color` | no direct equivalent | Install the skin source and author CSS when you need this palette role. |
| `--media-control-background` | no direct equivalent | Install the skin source and author CSS. |
| `--media-control-hover-background` | no direct equivalent | Install the skin source and author CSS. |
| `--media-range-track-height` | no direct equivalent | Install the skin source and author slider CSS. |
