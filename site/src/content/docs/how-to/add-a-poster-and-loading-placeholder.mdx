...
4. **Keep it working in a <DocsLink slug="how-to/customize-skins" anchor="install-and-edit-a-skin">source-owned skin</DocsLink>.** The player's `poster` still reaches the Poster component your skin renders, or you can set the image's source yourself.
...
Owning a skin's source changes nothing about the first two approaches: the player's `poster`, or the poster the media provides, still reaches the <DocsLink slug="reference/poster">Poster</DocsLink> component your skin renders.
...
- <DocsLink slug="how-to/customize-skins" anchor="style-a-packaged-skin">Customize skins</DocsLink>
