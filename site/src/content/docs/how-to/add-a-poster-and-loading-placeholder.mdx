...
4. **Keep it working in a <DocsLink slug="how-to/change-a-skins-controls-and-layout">source-owned skin</DocsLink>.** The player's `poster` still reaches the Poster component your skin renders, or you can set the image's source yourself.
