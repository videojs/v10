...
For changes to controls, layout, or icons, eject the skin into your project. Its components and styles become files you own. <DocsLink slug="how-to/customize-skins" anchor="eject-a-skin">Customize skins</DocsLink> covers the setup and available skins.
