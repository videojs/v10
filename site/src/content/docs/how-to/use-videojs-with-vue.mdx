...
Scoped styles cannot reach controls inside a packaged skin. Use its CSS custom properties, or <DocsLink slug="how-to/customize-skins" anchor="install-and-edit-a-skin">install an editable copy</DocsLink> to change its markup and CSS.
