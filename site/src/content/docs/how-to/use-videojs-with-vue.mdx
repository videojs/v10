...
Scoped styles cannot reach controls inside a packaged skin. Use its CSS custom properties, or <DocsLink slug="how-to/customize-skins" anchor="eject-and-edit-a-skin">eject the skin</DocsLink> to change its markup and CSS.
