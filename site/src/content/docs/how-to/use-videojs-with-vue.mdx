...
Scoped styles cannot reach controls inside a packaged skin. Use its CSS custom properties, or <DocsLink slug="how-to/customize-skins" anchor="own-and-customize-the-source">install an editable copy</DocsLink> to change its markup and CSS.
