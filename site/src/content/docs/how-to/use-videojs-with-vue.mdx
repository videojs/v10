...
Scoped styles cannot reach controls inside a packaged skin. Use its CSS custom properties, or <DocsLink slug="how-to/change-a-skins-controls-and-layout">install an editable copy</DocsLink> to change its markup and CSS.
