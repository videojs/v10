...
Scoped styles cannot reach controls inside a packaged skin. Use its CSS custom properties, or <DocsLink slug="how-to/customize-skins">install the skin's source</DocsLink> to own its markup and CSS.
