...
components: ['Controls']
api: ['controlsFeature']
keywords: ['hide video controls', 'controls visibility', 'user idle', 'auto hide controls', 'tap to show controls']
---
...
The media is paused (controls intentionally stay visible), a remote playback session is active, or something keeps triggering activity — for example a focused element inside the container receiving repeated events.
