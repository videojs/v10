...
Mux Player's separate primary and secondary colors don't map one-to-one to these four properties. If your design relies on both, eject the skin and style those surfaces directly.
