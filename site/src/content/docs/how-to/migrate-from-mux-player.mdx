...
**Ejecting** means installing the skin's source into your project and editing it, the way you would a shadcn component, because it is one. The packaged skin isn't compiled magic; it's a tree of components, and `npx shadcn@latest add @videojs/video` copies that tree into your project. <DocsLink slug="how-to/install-skins-from-the-registry">Install skins from the Shadcn registry</DocsLink> covers the setup for every packaged skin.
