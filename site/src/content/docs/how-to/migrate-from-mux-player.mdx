...
For changes to controls, layout, or interactions, eject the skin into your project. Its components and styles become files you own. <DocsLink slug="how-to/change-a-skins-controls-and-layout">Change a skin's controls and layout</DocsLink> covers the setup and available skins.
