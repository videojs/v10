...
<script type="module" src="{{VJS10_HTML_CDN_BASE}}/extensions/mux-data.js"></script>
...
- <DocsLink slug="concepts/skins">Skins</DocsLink>, <DocsLink slug="how-to/style-a-packaged-skin">Style a packaged skin</DocsLink>, and <DocsLink slug="how-to/change-a-skins-controls-and-layout">Change a skin's controls and layout</DocsLink>
