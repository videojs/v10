...
|---|---|
| `techOrder`, `html5.vhs.*` | [Techs become media components](#techs-become-media-extensions) |
...
- **Formats and techs** (`videojs-contrib-*`, YouTube, Vimeo, Mux). Replace with the matching media component. See [Techs become media components](#techs-become-media-extensions).
