...
Ejecting is also where you take on the skin's CSS. The packaged skins ship styles for everything above; a bare layout renders unstyled until you bring those along, which is why the registry installs the skin's stylesheet next to its markup.
