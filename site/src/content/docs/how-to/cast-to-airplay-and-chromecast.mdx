...
Use the <DocsLink slug="reference/google-cast">GoogleCast extension</DocsLink> with a <DocsLink slug="reference/cast-button">CastButton</DocsLink>, and add an <DocsLink slug="reference/airplay-button">AirPlayButton</DocsLink> for Safari. The prebuilt skins already include both buttons; add `GoogleCast` next to a streaming media component to enable the configurable Cast route.
