...
Read the AirPlay button reference for [HTML](/docs/framework/html/reference/components/airplay-button/) and [React](/docs/framework/react/reference/components/airplay-button/), and the Google Cast guide for [HTML](/docs/framework/html/guides/casting/) and [React](/docs/framework/react/guides/casting/).
