...
See the menu reference for [HTML](/docs/framework/html/components/menu/) and [React](/docs/framework/react/components/menu/), or the quality feature for [HTML](/docs/framework/html/components/feature-quality/) and [React](/docs/framework/react/components/feature-quality/).
...
Read the AirPlay button reference for [HTML](/docs/framework/html/components/airplay-button/) and [React](/docs/framework/react/components/airplay-button/), and the Google Cast guide for [HTML](/docs/framework/html/guides/cast-to-airplay-and-chromecast/) and [React](/docs/framework/react/guides/cast-to-airplay-and-chromecast/).
