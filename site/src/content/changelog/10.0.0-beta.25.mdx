...
See the menu reference for [HTML](/docs/framework/html/reference/components/menu/) and [React](/docs/framework/react/reference/components/menu/), or the quality feature for [HTML](/docs/framework/html/reference/api/feature-quality/) and [React](/docs/framework/react/reference/api/feature-quality/).
...
Read the AirPlay button reference for [HTML](/docs/framework/html/reference/components/airplay-button/) and [React](/docs/framework/react/reference/components/airplay-button/), and the Google Cast guide for [HTML](/docs/framework/html/guides/cast-to-airplay-and-chromecast/) and [React](/docs/framework/react/guides/cast-to-airplay-and-chromecast/).
...
Pick a source and try it from the installation guide for [HTML](/docs/framework/html/guides/installation/) and [React](/docs/framework/react/guides/installation/).
