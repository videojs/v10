...
See the menu reference for [HTML](/docs/framework/html/components/menu/) and [React](/docs/framework/react/components/menu/), or the quality feature for [HTML](/docs/framework/html/api/feature-quality/) and [React](/docs/framework/react/api/feature-quality/).
