...
| --- | --- | --- |
| `react`, `html5`, `vue`, `svelte`, `css3`, `tailwindcss`, `nextjs`, `vite`, `laravel`, `react-router`, `astro`, `npm`, `jsdelivr`, `youtube`, `vimeo`, `cloudflare`, `tiktok`, `twitch`, `spotify` | [SVG Logos](https://github.com/gilbarbara/logos) (`logos:*`) | CC0 1.0 |
