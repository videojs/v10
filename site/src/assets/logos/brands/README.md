...
| --- | --- | --- |
| `react`, `html5`, `vue`, `svelte`, `css3`, `tailwindcss`, `nextjs`, `vite`, `laravel`, `react-router`, `astro`, `youtube`, `vimeo`, `cloudflare`, `tiktok`, `twitch`, `spotify` | [SVG Logos](https://github.com/gilbarbara/logos) (`logos:*`) | CC0 1.0 |
| `github`, `linkedin`, `x-twitter`, `openai`, `claude`, `tanstack` | [Simple Icons](https://simpleicons.org) (`simple-icons:*`) | CC0 1.0 |
