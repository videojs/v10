...
- Stroke icons (`arrow-*`, `chevron-*`, `check`, `copy`, `check-circle`, `x-circle`, `x`, `info`, `lightbulb`,
  ...
  `live-streaming`, `at-sign`, `globe`, `link-square`, `book`, `code-square`, `pen`) come from [Huge Icons](https://hugeicons.com) via
...
- `arrow`, `dial-inner`, `dial-outer`, `dropdown-arrow`, `triangle-arrow` are Video.js originals.
