    ...
    contents: [
      {
        ...
        contents: [
          ...
          { slug: 'api/use-optional-player' },
          { slug: 'api/use-player-context' },
          { slug: 'api/player-context', frameworks: ['html'] },
          { slug: 'api/use-container', frameworks: ['react'] },
          { slug: 'api/use-optional-container' },
          { slug: 'api/use-container-attach' },
        ],
      },
      {
        sidebarLabel: 'Store',
        ...
        contents: [
          ...
          { slug: 'api/use-selector' },
          { slug: 'api/use-snapshot' },
          { slug: 'api/store-controller' },
          { slug: 'api/snapshot-controller' },
          { slug: 'api/subscription-controller' },
        ],
      },
      {
      ...
      },
      {
        ...
        contents: [
          ...
          { slug: 'api/use-media-instance' },
          { slug: 'api/use-media-attach' },
          { slug: 'api/use-attach-media' },
          { slug: 'api/use-media-extension' },
      ...
      },
      {
        ...
        contents: [
          { slug: 'api/use-menu-context' },
          { slug: 'api/use-optional-menu-context' },
          { slug: 'api/use-audio-track-options' },
          { slug: 'api/use-captions-options' },
          { slug: 'api/use-playback-rate-options' },
          { slug: 'api/use-quality-options' },
        ],
      },
      {
        ...
        contents: [
          { slug: 'api/use-dialog-context' },
          { slug: 'api/use-error-dialog-context' },
          { slug: 'api/use-popover-context' },
          { slug: 'api/use-tooltip-context' },
        ],
      },
      {
        ...
        contents: [
          { slug: 'api/use-tap-gesture' },
          { slug: 'api/use-double-tap-gesture' },
          { slug: 'api/use-hotkey' },
          { slug: 'api/use-hotkey-shortcut' },
        ],
      },
      {
        sidebarLabel: 'i18n',
        ...
        contents: [
          ...
          { slug: 'api/i-18-n-controller', sidebarLabel: 'I18nController' },
        ],
      },
      {
        sidebarLabel: 'Utils',
        ...
        contents: [
          { slug: 'api/use-button' },
          { slug: 'api/use-slider' },
          { slug: 'api/use-composed-refs' },
          { slug: 'api/use-latest-ref' },
          { slug: 'api/use-destroy' },
          { slug: 'api/merge-props', frameworks: ['react'] },
          { slug: 'api/render-element', frameworks: ['react'] },
          { slug: 'api/aria-key-shortcuts-controller' },
        ],
      },
    ],
  },
