    ...
    contents: [
      ...
      },
      {
        ...
        contents: [
          ...
          { slug: 'guides/cdn', frameworks: ['html'], redirectFrom: ['concepts/cdn'] },
          {
            ...
            frameworks: ['html'],
            redirectFrom: ['guides/self-host-the-player'],
          },
          {
            slug: 'guides/content-security-policy',
            redirectFrom: ['guides/configure-a-content-security-policy', 'concepts/security'],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        contents: [
          ...
          { slug: 'guides/controls', sidebarLabel: 'Controls', redirectFrom: ['guides/show-and-hide-controls'] },
          {
            slug: 'guides/poster',
            sidebarLabel: 'Poster and placeholder',
            redirectFrom: ['guides/add-a-poster-and-loading-placeholder'],
          },
          {
            slug: 'guides/captions',
            sidebarLabel: 'Captions and subtitles',
            redirectFrom: ['guides/show-captions-and-subtitles'],
          },
          {
            slug: 'guides/keyboard-shortcuts',
            sidebarLabel: 'Keyboard shortcuts and gestures',
            redirectFrom: ['guides/add-keyboard-shortcuts-and-gestures'],
          },
          { slug: 'guides/live-streams', sidebarLabel: 'Live streams', redirectFrom: ['guides/play-live-streams'] },
          { slug: 'guides/quality', sidebarLabel: 'Quality selector', redirectFrom: ['guides/add-quality-selector'] },
          {
            slug: 'guides/fullscreen',
            sidebarLabel: 'Fullscreen and orientation',
            redirectFrom: ['guides/go-fullscreen-and-lock-orientation'],
          },
          {
            slug: 'guides/picture-in-picture',
            sidebarLabel: 'Picture-in-picture',
            redirectFrom: ['guides/use-picture-in-picture'],
          },
          {
            slug: 'guides/thumbnails',
            sidebarLabel: 'Thumbnail previews',
            redirectFrom: ['guides/show-timeline-thumbnail-previews'],
          },
          {
            slug: 'guides/casting',
            sidebarLabel: 'AirPlay and Chromecast',
            redirectFrom: ['guides/cast-to-airplay-and-chromecast'],
          },
          {
          ...
          },
          {
            ...
            redirectFrom: ['guides/add-a-background-video'],
          },
          {
            slug: 'guides/internationalization',
            sidebarLabel: 'Internationalization',
            redirectFrom: ['guides/internationalize-the-player'],
          },
          {
            slug: 'guides/mux-data',
            sidebarLabel: 'Mux Data',
            redirectFrom: ['guides/monitor-playback-with-mux-data', 'concepts/mux-data'],
          },
        ],
      },
      {
