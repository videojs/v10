    ...
    contents: [
      ...
      },
      {
        ...
        contents: [
          ...
          { slug: 'components/i-18-n-controller', sidebarLabel: 'I18nController', frameworks: ['html'] },
          { slug: 'components/merge-props', frameworks: ['react'] },
          { slug: 'components/render-element', frameworks: ['react'] },
          { slug: 'components/use-attach-media', frameworks: ['react'] },
          { slug: 'components/use-audio-track-options', frameworks: ['react'] },
          { slug: 'components/use-button', frameworks: ['react'] },
          { slug: 'components/use-captions-options', frameworks: ['react'] },
          { slug: 'components/use-composed-refs', frameworks: ['react'] },
          { slug: 'components/use-container-attach', frameworks: ['react'] },
          { slug: 'components/use-destroy', frameworks: ['react'] },
          { slug: 'components/use-dialog-context', frameworks: ['react'] },
          { slug: 'components/use-double-tap-gesture', frameworks: ['react'] },
          { slug: 'components/use-error-dialog-context', frameworks: ['react'] },
          { slug: 'components/use-hotkey', frameworks: ['react'] },
          { slug: 'components/use-hotkey-shortcut', frameworks: ['react'] },
          { slug: 'components/use-latest-ref', frameworks: ['react'] },
          { slug: 'components/use-media-attach', frameworks: ['react'] },
          { slug: 'components/use-media-extension', frameworks: ['react'] },
          { slug: 'components/use-media-instance', frameworks: ['react'] },
          { slug: 'components/use-menu-context', frameworks: ['react'] },
          { slug: 'components/use-optional-container', frameworks: ['react'] },
          { slug: 'components/use-optional-menu-context', frameworks: ['react'] },
          { slug: 'components/use-optional-player', frameworks: ['react'] },
          { slug: 'components/use-playback-rate-options', frameworks: ['react'] },
          { slug: 'components/use-player-context', frameworks: ['react'] },
          { slug: 'components/use-popover-context', frameworks: ['react'] },
          { slug: 'components/use-quality-options', frameworks: ['react'] },
          { slug: 'components/use-selector', frameworks: ['react'] },
          { slug: 'components/use-slider', frameworks: ['react'] },
          { slug: 'components/use-snapshot', frameworks: ['react'] },
          { slug: 'components/use-tap-gesture', frameworks: ['react'] },
          { slug: 'components/use-tooltip-context', frameworks: ['react'] },
          { slug: 'components/aria-key-shortcuts-controller', frameworks: ['html'] },
          { slug: 'components/media-attach-mixin', frameworks: ['html'] },
          { slug: 'components/player-context', frameworks: ['html'] },
          { slug: 'components/snapshot-controller', frameworks: ['html'] },
          { slug: 'components/store-controller', frameworks: ['html'] },
          { slug: 'components/subscription-controller', frameworks: ['html'] },
        ],
      },
    ],
  },
