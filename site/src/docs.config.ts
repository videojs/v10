...
export const sidebar: Sidebar = [
  ...
  },
  {
    sidebarLabel: 'API',
    llmsDescription:
      'API reference for the player factory, features, hooks, controllers, translation tools, and lower-level utilities.',
    contents: [
      {
        sidebarLabel: 'Player',
        llmsDescription:
          'API reference for creating a player, reading its state, and the feature modules that give it capabilities.',
        contents: [
