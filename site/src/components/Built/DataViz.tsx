  ...
  return (
    <div className="bg-faded-black border border-dark-manila p-5 md:p-15 rounded-sm">
      ...
      <div className="flex gap-0.5">
        <p className="hidden md:flex text-display-h5 items-center py-0.5 px-8 rounded-2xl bg-faded-black border border-light-manila text-center text-light-manila font-display-extended uppercase font-bold">
          VJS 8
        </p>
      ...
      <div className="flex gap-0.5">
        <p className="hidden md:flex items-center text-display-h5 py-0 px-8 rounded-2xl bg-faded-black border border-orange text-center text-orange font-display-extended uppercase font-bold">
          VJS 10
        </p>
