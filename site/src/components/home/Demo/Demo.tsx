...
export default function Demo() {
  return (
    <section className="grid gap-y-20 lg:gap-y-0 gap-x-5 lg:grid-cols-2 mb-10 lg:mb-0 w-full max-w-305 mx-auto px-5">
      <section className="grid lg:grid-rows-subgrid row-span-4 lg:border-t lg:py-10 border-y-faded-black dark:border-y-light-manila">
        <h2 className="text-h2 dark:text-light-manila text-faded-black text-center font-display-extended uppercase font-bold mb-2.5 lg:mb-1.25">
          Assemble your player
        </h2>
        <p className="text-p2 mb-8 md:mb-10 dark:text-dark-manila text-warm-gray text-center font-instrument-sans font-light">
