...
export function Selectors({ currentFramework, currentSlug }: SelectorProps) {
  ...
  return (
    <div className="px-6 pb-6 pt-2.5 md:py-6 xl:p-6 border-b border-75-manila dark:border-faded-black">
      <div
      ...
      >
        <span className="text-p3 text-faded-black dark:text-light-manila">Framework</span>
        <Select
        ...
        />
        <span className="text-p3 text-faded-black dark:text-light-manila">Style</span>
        <Select
