...
3. Check that each component or compound part has a scoped responsibility and maps to useful rendered structure. Prefer CSS or pseudo-elements when a distinction is purely visual.
4. Review the whole public surface: props, callbacks, context, refs, render functions, data attributes, CSS custom properties, namespaces, and exports. Controlled or uncontrolled modes must each have a demonstrated consumer.
...
6. Inspect imports, dependencies, re-exports, client boundaries, and production tree shaking. Optional parts or integrations should not force unrelated code into a consumer bundle.
